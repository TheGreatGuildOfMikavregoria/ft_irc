...
#define ISUPPORT_TOKEN_LIST	"CASEMAPPING=ascii CHANLIMIT=#: CHANMODES=,k,l,it CHANNELLEN=50 CHANTYPES=# KICKLEN=500 PREFIX= TOPICLEN=500 USERLEN=8 NICKLEN=10 MAXTARGETS=1"
